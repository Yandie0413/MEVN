...
export const translations: Translations = {
  ...
  // Hero Section
  'hero.badge': { fr: 'Plateforme d\'apprentissage', en: 'Learning platform' },
  'hero.title1': { fr: 'Apprendre Sans', en: 'Learn Without' },
  'hero.title2': { fr: 'Limites', en: 'Limits' },
  'hero.subtitle': { fr: 'Maîtrisez des compétences recherchées à ton rythme, avec des cours structurés en chapitres et quiz. Construis ton avenir — un cours à la fois.', en: 'Master in-demand skills at your own pace, with courses structured into chapters and quizzes. Build your future — one course at a time.' },
  ...
  'cta.subtitle': { fr: 'Créez votre compte gratuit et accédez à nos cours dès aujourd\'hui.', en: 'Create your free account and access our courses today.' },
  ...
  'auth.login.accessCourses': { fr: 'Accédez à vos cours, suivez votre progression et obtenez vos certificats.', en: 'Access your courses, track your progress and earn your certificates.' },
  'auth.login.feature1': { fr: 'Des cours animés par chapitres et quiz', en: 'Courses structured into chapters and quizzes' },
  ...
  'auth.register.joinStudents': { fr: 'Crée ton compte, obtiens des certifications et progresse à ton rythme avec des cours structurés.', en: 'Create your account, earn certifications, and progress at your own pace with structured courses.' },
  'auth.register.step1': { fr: 'Créer ton compte gratuit', en: 'Create your free account' },
  'auth.register.step2': { fr: 'Explorer nos cours', en: 'Explore our courses' },
