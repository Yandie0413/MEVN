...
const filteredCourses = computed(() => {
  if (activeFilter.value === (i18n.isFrench ? 'Tous' : 'All')) {
    return storeCourses.value;
  }
  return storeCourses.value.filter(c => i18n.isFrench ? c.category === activeFilter.value : c.category === activeFilter.value);
});
...
<template>
  <div class="flex flex-col">
    ...
    <!-- Courses Grid -->
    <div class="grid grid-cols-3 gap-6 pb-4 pr-1">
      <div
